...
// for in swap contract before they can be pulled out - which happens on refund
// paths) that client and server will use for the specified network. Mainnet uses
// a constant value while test networks support setting a custom value
// during build.
