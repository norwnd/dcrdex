...
export const ID_LIMIT_ORDER_BUY_SELL_OUT_TOTAL_PREVIEW = 'LIMIT_ORDER_BUY_SELL_OUT_TOTAL_PREVIEW'
export const ID_LIMIT_ORDER_BUY_SELL_IN_TOTAL_PREVIEW = 'LIMIT_ORDER_BUY_SELL_IN_TOTAL_PREVIEW'
...
export const ID_ENABLE_ASSET_WALLET_MSG = 'ENABLE_ASSET_WALLET_MSG'
