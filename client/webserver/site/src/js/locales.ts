...
export const ID_LIMIT_ORDER_BUY_TOTAL_PREVIEW = 'LIMIT_ORDER_BUY_TOTAL_PREVIEW'
export const ID_LIMIT_ORDER_SELL_TOTAL_PREVIEW = 'LIMIT_ORDER_SELL_TOTAL_PREVIEW'
